...
if __name__ == "__main__":
    ...
    # plt.subplot(1, 2, 1)
    plt.plot(map(lambda (ds_one, ds_two): ds_two, diff_original_plot), map(lambda (ds_one, ds_two): ds_one, diff_original_plot),'o', label='Original Stars')
    ...
    # plt.subplot(1, 2, 2)
    plt.plot(map(lambda (dads_one, dads_two): dads_two, diff_adjusted_plot), map(lambda (dads_one, dads_two): dads_one, diff_adjusted_plot),'o', label='Adjusted Stars')
